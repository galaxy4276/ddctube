...
!function (t) {
  ...
  var r = e(1),
    ...
    for (f in v && (e = n), e) {
      l = ((s = !p && m && void 0 !== m[f]) ? m : e)[f], h = g && s ? c(l, r) : y && "function" == typeof l ? c(Function.call, l) : l, m && u(m, f, l, t & a.U), x[f] != l && i(x, f, h), y && w[f] != l && (w[f] = l);
    }
  };
  ...
  t.exports = function (t, n) {
    ...
    return function (n, c, v) {
      for (var d, y, g = i(n), m = o(g), x = r(c, v, 3), w = u(m.length), b = 0, S = e ? p(n, w) : a ? p(n, 0) : void 0; w > b; b++) {
        if ((h || b in m) && (y = x(d = m[b], b, g), t)) if (e) S[b] = y;else if (y) switch (t) {
          case 3:
            return !0;
  ...
  if (e(8)) {
    ...
    p(Wt, Ct), h(Wt, vt, Ct.values), p(Wt, {
      ...
      x ? (v = e(function (t, e, r, o) {
        ...
        if (b(e)) {
          if (!(e instanceof X || "ArrayBuffer" == (a = w(e)) || "SharedArrayBuffer" == a)) return xt in e ? Mt(v, e) : Tt.call(v, e);
          i = e, p = _t(r, n);
          var g = e.byteLength;
        ...
        var i;
        return s(t, v, f), b(e) ? e instanceof X || "ArrayBuffer" == (i = w(e)) || "SharedArrayBuffer" == i ? void 0 !== o ? new g(e, _t(r, n), o) : void 0 !== r ? new g(e, _t(r, n)) : new g(e) : xt in e ? Mt(v, e) : Tt.call(v, e) : new g(y(e));
      ...
      var M = E[vt],
          ...
          T = Ct.values;
      h(v, yt, !0), h(E, xt, f), h(E, wt, !0), h(E, gt, v), (a ? new v(1)[dt] == f : dt in E) || W(E, dt, {
        get: function get() {
          return f;
        }
        ...
        set: kt
      }), u(u.P + u.F * !j, f, Ct), r || E.toString == ht || (E.toString = ht), u(u.P + u.F * i(function () {
        new v(1).slice();
      }), f, {
        slice: Nt
  ...
  for (var r, o = e(1), i = e(15), u = e(30), c = u("typed_array"), a = u("view"), f = !(!o.ArrayBuffer || !o.DataView), s = f, l = 0, h = "Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array".split(","); l < 9;) {
  ...
  t.exports = function (t, n, e, v, d, y, g) {
    ...
    var m,
      ...
      return function () {
        ...
        F = P || b(d),
        M = d ? E ? b("entries") : F : void 0,
        j = "Array" == n && O.entries || P;

    if (j && (w = s(j.call(new t()))) !== Object.prototype && w.next && (f(w, S, !0), r || "function" == typeof w[l] || u(w, l, p)), E && P && "values" !== P.name && (_ = !0, F = function F() {
      return P.call(this);
    }), r && !g || !h && !_ && O[l] || u(O, l, F), c[n] = F, c[S] = p, d) if (m = {
      values: E ? F : b("values"),
      keys: y ? F : b("keys"),
      entries: M
    }, g) for (x in m) {
  ...
  function L(t, n, e) {
    ...
    for ((t = _(t)) != t || t === S ? (o = t != t ? 1 : 0, r = a) : (r = P(F(t) / M), t * (i = O(2, -r)) < 1 && (r--, i *= 2), (t += r + f >= 1 ? s / i : s * O(2, 1 - f)) * i >= 2 && (r++, i /= 2), r + f >= a ? (o = 0, r = a) : r + f >= 1 ? (o = (t * i - 1) * O(2, n), r += f) : (o = t * O(2, f - 1) * O(2, n), r = 0)); n >= 8; u[l++] = 255 & o, o /= 256, n -= 8) {
      ;
    }
  ...
  if (u.ABV) {
    ...
    if (o + (e = void 0 === e ? r - o : h(e)) > r) throw b("Wrong length!");
  ...
  t.exports = !f || e(2)(function () {
    ...
    for (var e = c(t), f = arguments.length, s = 1, l = i.f, h = u.f; f > s;) {
      for (var p, v = a(arguments[s++]), d = l ? o(v).concat(l(v)) : o(v), y = d.length, g = 0; y > g;) {
  ...
  var r,
    ...
    try {
      ...
      return (M || "function" == typeof PromiseRejectionEvent) && t.then(j) instanceof n && 0 !== P.indexOf("6.6") && -1 === b.indexOf("Chrome/66");
    } catch (t) {}
  }(),
      L = function L(t) {
    var n;
  ...
  A || (_F = function F(t) {
    v(this, _F, "Promise", "_h"), p(t), r.call(this);
    ...
    Promise: _F
  }), e(39)(_F, "Promise"), e(42)("Promise"), u = e(7).Promise, l(l.S + l.F * !A, "Promise", {
  ...
  t.exports = function (t) {
    return new Promise(function (n, s) {
      ...
      if (p.open(t.method.toUpperCase(), i(y, t.params, t.paramsSerializer), !0), p.timeout = t.timeout, p.onreadystatechange = function () {
        ...
        p && (s(f("Request aborted", t, "ECONNABORTED", p)), p = null);
      }, p.onerror = function () {
        s(f("Network Error", t, null, p)), p = null;
      }, p.ontimeout = function () {
        var n = "timeout of " + t.timeout + "ms exceeded";
        t.timeoutErrorMessage && (n = t.timeoutErrorMessage), s(f(n, t, "ECONNABORTED", p)), p = null;
  ...
  var r = e(1),
    ...
    return n._k = t, n;
      ...
      Y = q && "symbol" == _typeof(_I.iterator) ? function (t) {
    return "symbol" == _typeof(t);
  } : function (t) {
    return t instanceof _I;
  },
      $ = function $(t, n, e) {
    return t === V && $(W, n, e), m(t), n = S(n, !0), m(e), o(U, n) ? (e.enumerable ? (o(t, k) && t[k][n] && (t[k][n] = !1), e = _(e, {
      enumerable: E(0, !1)
  ...
  q || (c((_I = function I() {
    ...
    return this._k;
  }), P.f = Z, M.f = $, e(35).f = O.f = Q, e(46).f = K, F.f = tt, i && !e(31) && c(V, "propertyIsEnumerable", K, !0), v.f = function (t) {
    return X(p(t));
  }), u(u.G + u.W + u.F * !q, {
    Symbol: _I
  });
  ...
  for (var rt = j(p.store), ot = 0; rt.length > ot;) {
    d(rt[ot++]);
  }
  ...
  e(56)("replace", 2, function (t, n, e, v) {
    return [function (r, o) {
      ...
      for (var w, b = "", S = 0, E = 0; E < m.length; E++) {
        ...
        for (var _ = String(x[0]), O = f(s(u(x.index), h.length), 0), P = [], F = 1; F < x.length; F++) {
        ...
        if (p) {
          var j = [_].concat(P, O, h);
          void 0 !== M && j.push(M);
          var T = String(n.apply(void 0, j));
        } else T = d(_, h, O, P, M, n);
  ...
  e(56)("split", 2, function (t, n, e, s) {
    ...
    return v = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (t, n) {
      ...
      for (var w = 0, b = 0, S = []; b < h.length;) {
        ...
        if (null === _ || (E = l(c(m.lastIndex + (p ? 0 : b)), h.length)) === w) b = u(h, b, y);else {
  ...
  for (var r = e(81), o = e(32), i = e(11), u = e(1), c = e(15), a = e(41), f = e(5), s = f("iterator"), l = f("toStringTag"), h = a.Array, p = {
    CSSRuleList: !0,
    ...
    var y,
        ...
        x = u[g],
        w = x && x.prototype;
    if (w && (w[s] || c(w, s, h), w[l] || c(w, l, g), a[g] = h, m)) for (y in r) {
      w[y] || i(w, y, r[y], !0);
    }
  }
}, function (t, n, e) {
  ...
  var r = e(86),
    ...
    for (f in p && (e = n), e) {
      (s = !h && w && void 0 !== w[f]) && c(m, f) || (l = s ? w[f] : e[f], m[f] = p && "function" != typeof w[f] ? e[f] : y && s ? i(l, r) : g && w[f] == l ? function (t) {
  ...
  var r,
    ...
    e.href = URL.createObjectURL(n), e.download = "recorded.webm", document.body.appendChild(e), e.click();
      ...
      a = function a() {
    var t = new MediaRecorder(r);
    t.start(), t.addEventListener("dataavailable", c);
  },
      f = function () {
    var t,
      ...
      return regeneratorRuntime.wrap(function (t) {
        for (;;) {
          switch (t.prev = t.next) {
            ...
            case 3:
              n = t.sent, u.srcObject = n, u.mute = !0, u.play(), i.innerHTML = "Stop recording", r = n, a(), t.next = 15;
              break;
  ...
  }, a.Cancel = e(130), a.CancelToken = e(338), a.isCancel = e(125), a.all = function (t) {
  ...
  var c = document.getElementById("jsVideoPlayer"),
      ...
      f = document.getElementById("jsPlayButton"),
      s = document.getElementById("jsVolumeBtn"),
      l = document.getElementById("jsFullScreen"),
      h = document.getElementById("currentTime"),
      p = document.getElementById("totalTime"),
      v = document.getElementById("jsVolume");

  function d() {
    console.log("handlePlayClick Function Running"), a.paused ? (a.play(), f.innerHTML = '<i class="fas fa-pause"></i>') : (a.pause(), f.innerHTML = '<i class="fas fa-play"></i>');
  }

  function y() {
    a.muted ? (a.muted = !1, s.innerHTML = '<i class="fas fa-volume-up"></i>', v.value = a.volume) : (a.muted = !0, s.innerHTML = '<i class="fas fa-volume-mute"></i>', v.value = 0);
  }

  function g() {
    l.innerHTML = '<i class="fas fa-expand"></i>', l.addEventListener("click", m), document.webkitExitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen ? document.webkitExitFullscreen() : document.msExitFullscreen && document.msExitFullscreen();
  }

  function m() {
    c.requestFullscreen ? c.requestFullscreen() : c.mozRequestFullScreen ? c.mozRequestFullScreen() : c.webkitRequestFullScreen ? c.webkitRequestFullScreen() : c.msRequestFullScreen && c.msRequestFullScreen(), l.innerHTML = '<i class="fas fa-compress"></i>', l.removeEventListener("click", m), l.addEventListener("click", g);
  }
  ...
  function w() {
    h.innerHTML = x(Math.floor(a.currentTime));
  }
  ...
  function S() {
    return (S = u(regeneratorRuntime.mark(function t() {
      var n, e, r;
      return regeneratorRuntime.wrap(function (t) {
        for (;;) {
          switch (t.prev = t.next) {
            ...
            case 5:
              e = t.sent, console.log(e), r = x(e), p.innerHTML = r, setInterval(w, 1e3);
  ...
  function E() {
    ...
    t = window.location.href.split("/videos/")[1], fetch("/api/".concat(t, "/view"), {
      method: "POST"
    }), a.currentTime = 0, f.innerHTML = '<i class="fas fa-play"></i>';
  }

  function _(t) {
    var n = t.target.value;
    a.volume = n, n > .7 ? s.innerHTML = '<i class="fas fa-volume-up"></i>' : n > .4 ? s.innerHTML = '<i class="fas fa-volume-down"></i>' : n >= 0 && (s.innerHTML = '<i class="fas fa-volume-off"></i>');
  }

  c && (a.volume = .5, f.addEventListener("click", d), s.addEventListener("click", y), l.addEventListener("click", m), a.addEventListener("loadedmetadata", b), a.addEventListener("ended", E), v.addEventListener("input", _));
  e(322);
  var O = e(132),
      P = e.n(O);
  ...
  var M = document.getElementById("jsAddComment"),
      j = document.getElementById("jsCommentList"),
      T = document.getElementById("jsCommentNumber"),
      A = document.getElementById("jsCommentDelBtn"),
      L = function L(t) {
    var n = document.querySelector("span");
    document.querySelector("li").removeChild(n), T.innerHTML = parseInt(T.innerHTML, 10) - 1;
  },
      I = function I(t) {
    var n = document.createElement("li"),
        e = document.createElement("span");
    e.innerHTML = t, n.appendChild(e), j.prepend(n), T.innerHTML = parseInt(T.innerHTML, 10) + 1;
  },
      R = function () {
    var t,
      ...
      return regeneratorRuntime.wrap(function (t) {
        for (;;) {
          switch (t.prev = t.next) {
            case 0:
              return e = window.location.href.split("/videos/")[1], console.log(e), t.next = 4, P()({
    ...
    return function (t) {
      ...
      N = function N(t) {
    t.preventDefault();
    var n = M.querySelector("input"),
        e = n.value;
    R(e), n.value = "";
  };

  M && (M.addEventListener("submit", N), A.addEventListener("click", L));
}, function (t, n) {}]);